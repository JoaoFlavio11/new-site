  ...
  return (
    <section id={id} className={`py-24 px-6 ${className}`}>
      <div className="max-w-6xl mx-auto">
        ...
        >
          {centered ? (
            // Layout Centralizado (ex: Certificados)
            <>
              <div className="text-neutral-500 mb-4 group-hover:text-sky-500 transition-colors">
                {icon}
              </div>
            ...
            // Layout Alinhado à Esquerda (ex: Livros e Projetos)
            <>
